    ...
    <!-- /End Footer -->
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-info container">
				...
				<div class="et-footer">
					<p>
						<a href="https://galussothemes.com/wordpress-themes/" target="_blank" title="Premium Wordpress theme" rel="author nofollow">Premium Wordpress theme</a> by <a href="https://galussothemes.com/" target="_blank" title="Wordpress themes" rel="author nofollow">Galussothemes</a>
					</p>
			    </div>
			</div><!-- .site-info -->
